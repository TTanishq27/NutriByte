...
function page1() {
  ...
  return (
    <motion.div initial={{ opacity: 0, x: "-100%" }}
      animate={{ opacity: 1, x: "0%" }} transition={{ duration: 1.5, staggerChildren: .5, ease: [0.85, 0, 0.15, 1] }} className='h-screen relative top-6 flex justify-center items-center gap-40'>
    ...
    <motion.div initial={{x: 0}} whileInView={{x: "-80%"}} transition={{duration: 30, repeat: Infinity, repeatType: "loop", ease:'linear'}} className="absolute text-[20vw] bottom-0 whitespace-nowrap left-0 text-[#1c6758] font-bold opacity-20 -z-10 cursor-default">
